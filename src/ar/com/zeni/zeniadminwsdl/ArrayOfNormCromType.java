 ...
 *       &lt;sequence>
 *         &lt;element name="normas" type="{http://www.zeni.com.ar/ZeniAdminWSDL/}NormCromType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfNormCromType {
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2012-11-23T03:17:13-03:00", comments = "JAXB RI v2.2.5-2")
    public synchronized List<NormCromType> getNormas() {
        if (normas == null) {
