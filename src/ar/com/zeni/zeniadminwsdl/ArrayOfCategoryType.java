 ...
 *       &lt;sequence>
 *         &lt;element name="categs" type="{http://www.zeni.com.ar/ZeniAdminWSDL/}CategoryType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfCategoryType {
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2012-11-23T03:17:13-03:00", comments = "JAXB RI v2.2.5-2")
    public synchronized List<CategoryType> getCategs() {
        if (categs == null) {
