...
public class JCalendar extends JPanel implements PropertyChangeListener {
  ...
  public JCalendar(String[] days, String[] months) {
    setDayNames(days);
  ...
  public JCalendar(Date date, Locale locale, boolean monthSpinner,
    ...
    init(date, locale, monthSpinner, weekOfYearVisible);
  }

  public void init(Date date, Locale locale, boolean monthSpinner,
      boolean weekOfYearVisible) {
    ...
    monthChooser = new JMonthChooser(monthSpinner,monthNames);
    ...
    if (dayNames != null) {
      dayChooser = new JDayChooser(weekOfYearVisible, dayNames);
    }
    else {
  ...
  public void propertyChange(PropertyChangeEvent evt) {
    if (calendar != null) {
      ...
      if (evt.getPropertyName().equals("day")) {
        ...
        setCalendar(c, ((Integer) evt.getOldValue()).intValue() == 99);
      }
