...
@XmlType(name = "ArrayOfResultadosMercadoATerminoType", propOrder = {
    "resultados"
})
public class ArrayOfResultadosMercadoATerminoType {

    protected List<ResultadosMercadoATerminoType> resultados;
     ...
     * 
     */
    public List<ResultadosMercadoATerminoType> getResultados() {
        if (resultados == null) {
        	resultados = new ArrayList<ResultadosMercadoATerminoType>();
        }
