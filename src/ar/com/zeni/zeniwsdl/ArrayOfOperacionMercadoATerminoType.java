...
@XmlType(name = "ArrayOfOperacionMercadoATerminoType", propOrder = {
    "mercater"
})
public class ArrayOfOperacionMercadoATerminoType {

    protected List<OperacionMercadoATerminoType> mercater;
     ...
     * 
     */
    public List<OperacionMercadoATerminoType> getMercater() {
        if (mercater == null) {
            mercater = new ArrayList<OperacionMercadoATerminoType>();
        }
