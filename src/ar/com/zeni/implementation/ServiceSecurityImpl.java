...
public abstract class ServiceSecurityImpl implements ZeniWSDL {
	...
	@Override
	public java.lang.String obtenerCodigoDeAutorizacion(String usuario, String email) throws FaultType_Exception {
		...
		try {
			...
			java.lang.String _return = "Se enviara el codigo de autorizacion al mail " + email + ". En breve revise su correo.";
			return _return;
		} catch (ZeniDBExeption ex) {
			FaultType f = new FaultType();
			f.setMensaje(ex.getMessage());
	...
	@Override
	public java.lang.String resetearPassword(java.lang.String usuario, java.lang.String email, java.lang.String codigoDeAutorizacion) throws FaultType_Exception {
		...
		try {
			...
			java.lang.String _return = "Se enviara el password nuevo su mail.\nEn breve revise su correo.";
			return _return;
		} catch (ZeniDBExeption ex) {
			FaultType f = new FaultType();
			f.setMensaje(ex.getMessage());
	...
	@Override
	public ar.com.zeni.zeniwsdl.AuthType autorizarUsuario(java.lang.String usuario, java.lang.String hash, java.lang.String password) throws FaultType_Exception {
