    ...
    public ar.com.zeni.zeniwsdl.ArrayOfEntregaByContratoType obtenerEntregasByContrato(AuthType auth, String idContrato)
        ...
        try {
            ...
            final StringBuilder querySBuilder = new StringBuilder().append("")
                    ...
                    .append("a.remito nroremito, a.observaciones ").append("FROM ( ").append("SELECT rownum columna, ")
                    ...
                    .append("e.useralta conf, ").append("e.porcentajeZarandeo zarandeo, ").append("e.ctg ctg, ")
                    ...
                    .append("e.nroRemito remito, e.observaciones  ").append("FROM entrega_partida ep ")
                    ...
                    .append("on (c.id=ep.contrato_id) ")
                    // #2063
                    .append("INNER JOIN WORKFLOW_STATE ws ON ").append("(ws.id = ep.state_id)  ")
